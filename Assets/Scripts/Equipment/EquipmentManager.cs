...
public class EquipmentManager : MonoBehaviour
{
    ...
    private void EquipItem(GameObject equipmentPrefab) {          
        if (!equipmentPrefab.TryGetComponent<Equipment>(out var equipment)) {
            ...
            UnequipItem(newAbility.AbilityInfo.Slot, Equipment.EquipmentType.Ability, false);
            ...
            UnequipItem(newArmor.ArmorInfo.Slot, Equipment.EquipmentType.Armor, false);
    ...
    public void UnequipItem( EquipmentSlot slot, Equipment.EquipmentType type, bool isGame) {
        if (type == Equipment.EquipmentType.Ability && _abilityDict[slot] != null) {
            ...
            _armorDict[slot].DestroyArmor(isGame);
